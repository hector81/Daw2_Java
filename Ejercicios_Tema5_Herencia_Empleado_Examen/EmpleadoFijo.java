 ...
 */
package Ejercicios_Tema5_Herencia_Empleado_Examen;
...
public class EmpleadoFijo extends Empleado {
    ...
    //constructor
    public EmpleadoFijo(String nif, String nombre, int edad, Calendar yearAlta,
            Calendar yearBaja) {
    ...
    public double calculaSueldo() {
        double smi =580.00;
        return smi + (20*diferenciaNumeroYears(yearAlta,yearBaja));
    }  
