...
public class DosFechasDiferencia {
    // main
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (mes2 < 1 || mes2 > 12) {
                System.out.println("El mes de la segunda fecha esta equivocado. ");
            }
            ...
            //IF PARA aviso error
            if ((ano1 < 1 || ano1 > 2015 || mes1 < 1 || mes1 > 12 || dia1 < 1 || dia1 > 30
                    || ano2 < 1 || ano2 > 2015
                    || mes2 < 1 || mes2 > 12 || dia2 < 1 || dia2 > 30)) {
                System.out.println("HAS METIDO DATOS ERRONEOS. TODOS LOS DATOS DEBEN SER"
                        + " CORRECTOS. VUELVE A INTRODUCIRLOS. ");
            }
        } while ((ano1 < 1 || ano1 > 2015) || (mes1 < 1 || mes1 > 12) || (dia1 < 1 || dia1 > 30)
                || (ano2 < 1 || ano2 > 2015)
                || (mes2 < 1 || mes2 > 12) || (dia2 < 1 || dia2 > 30));
        // fin do while
        ...
        //realizar calculos
        dia = dia1 - dia2;
        //si la diferencia es negativa , la multiplicamos por -1 para que sea positiva
        if (dia < 0) {
            dia = dia * -1;
        }
        //si la diferencia es negativa , la multiplicamos por -1 para que sea positiva
        ...
        System.out.println("La diferencia en d�as entre las 2 fechas es : " + resultado);
