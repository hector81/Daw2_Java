 ...
 * @author user
 */
public class Cardp extends JFrame implements ActionListener{
    private JPanel AÑADIR, BORRAR, MODIFICAR, CONSULTAR, NORTE, SUR;
    ...
    public Cardp() {
        ...
        this.SUR = new JPanel(new BorderLayout());
        ...
        this.AÑADIRnorte = new JPanel(new FlowLayout());
        ...
        this.BORRARnorte = new JPanel(new FlowLayout());
        ...
        this.MODIFICARnorte = new JPanel(new FlowLayout());
        ...
        this.CONSULTARnorte = new JPanel(new FlowLayout());
        ...
        this.CONSULTARnorte.add(jlnombreCONSULTAR);
        this.CONSULTARnorte.add(jtnombreCONSULTAR);
        this.CONSULTARnorte.add(jlapellidosCONSULTAR);
        this.CONSULTARnorte.add(jtapellidosCONSULTAR);
        this.CONSULTARnorte.add(jledadCONSULTAR);
        this.CONSULTARnorte.add(jtedadCONSULTAR);
        this.CONSULTARnorte.add(jldniCONSULTAR);
        this.CONSULTARnorte.add(jtdniCONSULTAR);
        ...
        this.SUR.add(AÑADIR);
        this.SUR.add(BORRAR);
        this.SUR.add(MODIFICAR);
        this.SUR.add(CONSULTAR);
