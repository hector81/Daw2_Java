...
public class VistaSwing extends JFrame implements InterfazVista{
    private JPanel jpMain,jpBotones ,jpDatos,jpApuesta;
    private Dimension d;
    private int puntosJugador, puntosCrupier;
    private JLabel jlApuesta,jlNombre,jlSaldo,jlJugadorPuntos,jlCrupierPuntos, jlbMain;
    ...
    public VistaSwing() {
        ...
        jlbMain = new JLabel(new ImageIcon("E:\\BlackJack\\src\\fotosCartas\\tapete.jpg"));
        jpMain.add(jlbMain);
